...
def get_model(
    ...
    try:
        ...
        elif model_type == ModelType.LiteratureAgent:
            from .LiteratureAgent import LiteratureAgent_Client
            model = LiteratureAgent_Client(model_name, access_key, user_name=user_name)
        elif model_type == ModelType.NovelAgent:
            from .NovelAgent import NovelAgent_Client
            model = NovelAgent_Client(model_name, access_key, user_name=user_name)
